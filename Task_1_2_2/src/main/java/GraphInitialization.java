...
public class GraphInitialization {
    ...
    /**
     * Representation of a graph in a file and its further storage in a file in the form of an incidence matrix.
     * The first number in the file is the number of vertices. If an edge goes from one vertex to another vertex,
     * then the name of this vertex is written at the end of the corresponding row in the adjacency matrix.
     * @param filename the name of the file to read
     * @return filled graph
     */
    public GraphAdjacencyMatrix<String> byAdjMatrix(String filename) {
        int vertexCount, edgesCount, weight;
        String from, to, edge, line, vertex;
        String[] splited;
    ...
    /**
     * Representation of a graph in a file and its further storage in a file in the form of an adjacency list.
     * The first number in the file is the number of vertices. Then the names of all the vertices.
     * For each vertex in the graph, the number of incident vertices is written. Each row with the name
     * of the incident vertex contains the weight and the name of the edge that connects them.
     * @param filename the name of the file to read
     * @return filled graph
     */
    public GraphAdjacencyList<String> byAdjList(String filename) {
        int vertexCount, edgesCount, weight;
        String from, to, edge, line;
        String[] splited;
    ...
    /**
     * Representation of a graph in a file and its further storage in a file in the form of an incidence matrix.
     * The first number in the file is the number of vertices, the second number is the number of edges.
     * In the incidence matrix, each row corresponds to one edge of the graph. The first parameter of the string
     * is the name of the edge, the last is its weight.
