...
/**
 * Class for analyzing command-line parameters and for serialization notebook data to a notebook.json file.
...
public class Main {
    ...
    public static void main(String[] args) throws ParseException, FileNotFoundException,
        ...
        {
            notebook.addNote(commandLine.getOptionValues("add")[0], commandLine.getOptionValues("add")[1]);
            ...
            ArrayList<String> keywords = new ArrayList<>(Arrays.asList(commandLine.getOptionValues("select")));
            keywords.remove(0);
            keywords.remove(0);
